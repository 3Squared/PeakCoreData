...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://gitlab.3squared.com/davidyates/SQKCoreDataKit.git"
  s.license      = { :type => 'Custom', :file => 'LICENCE' }
  s.author       = { "David Yates" => "david.yates@3squared.com" }
  s.platform     = :ios, "9.0"
  s.requires_arc = true
  s.source       = { :git => "git@gitlab.3squared.com:davidyates/SQKCoreDataKit.git", :tag => s.version.to_s }
  s.source_files = "SQKCoreDataKit", "SQKCoreDataKit/**/*.{h,m,swift}"
